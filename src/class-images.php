<?php
/**
 * Get a representative image from a post.
 *
 * This is a copy of the Jetpack_PostImages class in the Jetpack plugin.
 * When that class is available as part of a package, I'll use that instead.
 *
...
class Images {
	...
	public static function get_images( $post_id, $args = array() ) {
		...
		$defaults = array(
			...
			'fallback_to_avatars' => false, // Optionally include Gravatar (in that order) in the image stack.
